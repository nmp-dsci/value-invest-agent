...
- relative_buy — he says "buy" about it at this price: "relative buy", "good buy at the moment", "a much better buy than X", he buys it (even "a little"), he is accumulating it, "buy and forget". Saying it is fairly valued or "interesting" is NOT a buy.
- fair_hold — a stock he could own at this price without recommending it: "fairly valued / fairly priced for a 10 % return", "good business, priced for a 8–10 % return", "not a bad addition to a portfolio" (even if he personally passes), "a little bit overvalued, wait for a better price" while positive on the business, "contender / start following / keep watching".
- avoid — he would not own it at this price and says so: overvalued, "not for the value investor", "nothing to do there", "too risky for the return", "a bet I would not take", "wake me up when it is down 50 %", "leave it to pension funds", "not a great buy nor a hold", "only interesting 30 % lower", "has not yet triggered", or a return he calls low (≤ 7 %) while saying he is not interested. The test: would he own it here? fair_hold = yes/maybe, avoid = no.
